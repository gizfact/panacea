...
const char *AppForms[FORMS_COUNT] = {   "‘отрудники", "Љлиенты", "’ипы абонементов", "‘кидки",
                                        "Ћтчет Ѓалансы", "Џрайс-листы", "“слуги", "Ћстатки",
                                        "Џриход", "–ены на услуги", "Ћтчет ‡адолженности", "Ћтчет ЏосещениЯ",
                                        "ЋбщаЯ скидка", "Ћтчет ЏосещениЯ SPA", "Ћтчет Ђбонементы SPA", "“слуги - Њатериалы",
                                        "Ћтрицательный Ѓаланс", "ђасписание групповых занЯтий", "Љалендарь"
                                    };
    ...
    : TForm(Owner)
{
    ...
    {
        // Oooops...
        Application->MessageBox("‚нимание!\n‡апуск программы невозможен.","[ERROR 111]",MB_OK);
    ...
    //{
        // Oooops...
    //    Application->MessageBox("‚нимание!\n‡апуск программы невозможен.","[ERROR 117]",MB_OK);

    //    TerminateProcess(GetCurrentProcess(),1);
    //    return;
    //}
    
    // €нициализация уникального ID для кассы
