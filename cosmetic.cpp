...
//---------------------------------------------------------------------------
__fastcall TCosmeticForm::TCosmeticForm(TComponent* Owner)
    : TForm(Owner)
{
    pServicesIDs = NULL;
    pServices = NULL;
...
//---------------------------------------------------------------------------
void __fastcall TCosmeticForm::lbServicesUpdate(void)
{
    delete [] pServicesIDs;
    delete [] pServices;
    pServicesIDs = NULL;
...
//---------------------------------------------------------------------------
void __fastcall TCosmeticForm::lbServices2Update(void)
{
...
//---------------------------------------------------------------------------
void __fastcall TCosmeticForm::lbPersonalUpdate(void)
{
    lbPersonal->Clear();
...
//---------------------------------------------------------------------------
void __fastcall TCosmeticForm::laPriceUpdate(void)
{
    TListBox *pCombo;
    __int64 *pIDs;
...
//---------------------------------------------------------------------------
double __fastcall TCosmeticForm::GroupAnalyze(AnsiString group,int cnt)
{
    typedef struct
    {
        int Cnt1;
...
//---------------------------------------------------------------------------
void __fastcall TCosmeticForm::FormDestroy(TObject *Sender)
{
    delete [] pLevel2IDs;
    delete [] pLevel2;
    ...
    SaveBoxSize("Cosmetic",lbLevel01,lbLevel02,lbLevel03);
}
//---------------------------------------------------------------------------
void __fastcall TCosmeticForm::FormShow(TObject *Sender)
{
    SQL_exefun(DBName,"select RowID from Services where Name='Кабинет косметологии'",&retString);
    ...
    LoadBoxSize("Cosmetic",lbLevel01,lbLevel02,lbLevel03);
...
//---------------------------------------------------------------------------
void __fastcall TCosmeticForm::lbLevel01Click(TObject *Sender)
{
    lbServicesUpdate();
}
//---------------------------------------------------------------------------
void __fastcall TCosmeticForm::lbLevel02Click(TObject *Sender)
{
    lbServices2Update();
}
//---------------------------------------------------------------------------
void __fastcall TCosmeticForm::lbLevel03Click(TObject *Sender)
{
...
//---------------------------------------------------------------------------
void __fastcall TCosmeticForm::bOKClick(TObject *Sender)
{
    if(AddOp == 1 && !AddCount)
    {
...
//---------------------------------------------------------------------------
void __fastcall TCosmeticForm::bCancelClick(TObject *Sender)
{
    Close();
}
//---------------------------------------------------------------------------
void __fastcall TCosmeticForm::Button1Click(TObject *Sender)
{
    ...
    {
        AddType = 1;
        AddPrice = 18.0 * AddCount;
    }
    if(RadioButton2->Checked)
    {
        AddType = 2;
        AddPrice = 13.0 * AddCount;
    }
...
//---------------------------------------------------------------------------
void __fastcall TCosmeticForm::lbLevel01Enter(TObject *Sender)
{
    Panel2->Visible = false;
}
//---------------------------------------------------------------------------
void __fastcall TCosmeticForm::lbLevel02Enter(TObject *Sender)
{
    Panel2->Visible = false;
}
//---------------------------------------------------------------------------
void __fastcall TCosmeticForm::Button2Click(TObject *Sender)
{
    Panel2->Visible = false;
}
//---------------------------------------------------------------------------
void __fastcall TCosmeticForm::edColorKeyPress(TObject *Sender, char &Key)
{
    ui_keyfilter(Key);
}
//---------------------------------------------------------------------------
void __fastcall TCosmeticForm::seGroupCntChange(TObject *Sender)
{
    laPriceUpdate();
}
//---------------------------------------------------------------------------

void __fastcall TCosmeticForm::FormPaint(TObject *Sender)
{
    if(CloseFlag)
        Close();
}
