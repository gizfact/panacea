...
//---------------------------------------------------------------------------
__fastcall TNailForm::TNailForm(TComponent* Owner)
    : TForm(Owner)
{
    CloseFlag = false;
...
//---------------------------------------------------------------------------
void __fastcall TNailForm::lbServicesUpdate(void)
{
    delete [] pServicesIDs;
    delete [] pServices;
    pServicesIDs = NULL;
...
//---------------------------------------------------------------------------
void __fastcall TNailForm::lbServices2Update(void)
{
...
//---------------------------------------------------------------------------
void __fastcall TNailForm::lbPersonalUpdate(void)
{
    lbPersonal->Clear();
...
//---------------------------------------------------------------------------
void __fastcall TNailForm::laPriceUpdate(void)
{
    TListBox *pCombo;
    __int64 *pIDs;
...
//---------------------------------------------------------------------------
double __fastcall TNailForm::GroupAnalyze(AnsiString group,int cnt)
{
    typedef struct
    {
        int Cnt1;
...
//---------------------------------------------------------------------------
void __fastcall TNailForm::FormDestroy(TObject *Sender)
{
    delete [] pLevel2IDs;
    delete [] pLevel2;
    ...
    // Box
    SaveBoxSize("Nail",lbLevel01,lbLevel02,lbLevel03);
}
//---------------------------------------------------------------------------
void __fastcall TNailForm::FormShow(TObject *Sender)
{
    SQL_exefun(DBName,"select RowID from Services where Name='Ногтевой сервис'",&retString);
    ...
    LoadBoxSize("Nail",lbLevel01,lbLevel02,lbLevel03);
...
//---------------------------------------------------------------------------
void __fastcall TNailForm::lbLevel01Click(TObject *Sender)
{
    lbServicesUpdate();
}
//---------------------------------------------------------------------------
void __fastcall TNailForm::lbLevel02Click(TObject *Sender)
{
    lbServices2Update();
}
//---------------------------------------------------------------------------
void __fastcall TNailForm::lbLevel03Click(TObject *Sender)
{
...
//---------------------------------------------------------------------------
void __fastcall TNailForm::bOKClick(TObject *Sender)
{
    if(AddOp == 1 && !AddCount)
    {
...
//---------------------------------------------------------------------------
void __fastcall TNailForm::bCancelClick(TObject *Sender)
{
    Close();
}
//---------------------------------------------------------------------------
void __fastcall TNailForm::Button1Click(TObject *Sender)
{
...
//---------------------------------------------------------------------------
void __fastcall TNailForm::lbLevel01Enter(TObject *Sender)
{
    Panel2->Visible = false;
}
//---------------------------------------------------------------------------
void __fastcall TNailForm::lbLevel02Enter(TObject *Sender)
{
    Panel2->Visible = false;
}
//---------------------------------------------------------------------------
void __fastcall TNailForm::Button2Click(TObject *Sender)
{
    Panel2->Visible = false;
}
//---------------------------------------------------------------------------
void __fastcall TNailForm::edColorKeyPress(TObject *Sender, char &Key)
{
    ui_keyfilter(Key);
}
//---------------------------------------------------------------------------
void __fastcall TNailForm::seGroupCntChange(TObject *Sender)
{
    laPriceUpdate();
}
//---------------------------------------------------------------------------
void __fastcall TNailForm::FormPaint(TObject *Sender)
{
    if(CloseFlag)
        Close();
}
